...
public class MainClass {
	...
	MainClass mc = new MainClass();Dont you try to trick me.. I can detect cycles..
...
Combine compute_function_body_assembly21 = new Combine( "body" , 1, resource_ratio_body_assembly21 , 100 , "null" );
...
Combine compute_function_body_assembly11 = new Combine( "body" , 1, resource_ratio_body_assembly11 , 100 , "null" );
...
Combine compute_function_car_assembly1 = new Combine( "car" , 1, resource_ratio_car_assembly1 , 50 , "null" );
...
Combine compute_function_base_assembly1 = new Combine( "base" , 2, resource_ratio_base_assembly1 , 10 , "null" );
...
for (String node:all) {double d = syslib.getNodeWaitingTime(node);
if (d<10.0) {System.out.println(node);}}
System.out.println ( "Program Terminating successfully.");System.exit(0);}
}
