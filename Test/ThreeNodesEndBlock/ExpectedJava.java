...
public class MainClass {
	...
	MainClass mc = new MainClass();Node CPU_Maker = new Node("CPU_Maker",false);
...
Combine compute_function_CPU_Maker1 = new Combine( "cpu" , 5, resource_ratio_CPU_Maker1 , 10 , "null" );
...
Combine compute_function_Monitor_Maker1 = new Combine( "monitor" , 5, resource_ratio_Monitor_Maker1 , 10 , "null" );
...
Combine compute_function_Desktop_Maker1 = new Combine( "desktop" , 5, resource_ratio_Desktop_Maker1 , 5 , "null" );
...
for (String node:all) {double d = syslib.getTime(node);
if (i<d) {i=d;}}
