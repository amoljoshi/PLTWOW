...
public class MainClass {
	...
	final int totalOutputQuantity = 4; //final output quantity defined in the Node A resource block
	...
	private void start() throws IOException {
		...
		//retrieve the resource name from resource table formed after parsing --------------------- just printing i guess
