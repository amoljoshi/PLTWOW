...
public class Node{
    ...
    private HashMap<String, ArrayList<Integer>> UnsyncOutputResources = new HashMap <String, Integer>();
    // edits
    private HashMap<String, ArrayList<Integer>> intermediateInputResources = new HashMap <String, ArrayList<Integer>>(); // --------------------- CHANGE THIS. MAKE VALUE AN ARRAY LIST OF ORIGINAL AND UPDATED VALUES
    private HashMap<String, ArrayList<Integer>> outputResources = new HashMap <String, ArrayList<Integer>>(); // --------------------- CHANGE THIS. MAKE VALUE AN ARRAY LIST OF ORIGINAL AND UPDATED values
    // edits
...
//#############################################################################################################################//    
    ...
    */
    public String toString(){
        ...
        while (it.hasNext()) {
            Map.Entry pair = (Map.Entry)it.next();
            s+= "\t\t ID = " + pair.getKey() + " quantity = " + pair.getValue().get(1) + "\n";
        }
